...
public class TaskBuilder {
    ...
    public static TaskInfo buildTaskInfo(TaskDescription description,
        ...
        if (tmProperties != null) {
            Iterator i = tmProperties.keySet().iterator();
            while (i.hasNext()) {
                String name = (String) i.next();
//                if ("xmlProperties".equals(name)) {
//                    Map map = (Map) tmProperties.get(name);
//                    if (map != null) {
...
//                }
        ...
        NTaskAdapter.addProperty(nameGroup, description.getResource(TaskDescription.INSTANCE));
