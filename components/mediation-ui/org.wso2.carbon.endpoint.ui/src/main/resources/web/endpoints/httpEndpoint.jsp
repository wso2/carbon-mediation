...
%><fmt:message key="http.endpoint.template"/><%
} else {
%><fmt:message key="http.endpoint"/><%
    }
%>
</h2>
        ...
        <table class="styledLeft">
            ...
            <tr>
                <th><span style="float: left; position: relative; margin-top: 2px;">
                            <fmt:message key="design.view.of.the.http.endpoint"/></span>
                    <a class="icon-link"
                       style="background-image: url(images/source-view.gif);"
                       onclick="switchToSource('Http','<%=isAnonymous%>','<%=isFromTemplateEditor%>');"
            ...
            <tr>
                <td>
                    <div id="endpointForm">
                        <jsp:include page="forms/httpEndpoint-form.jsp" flush="true">
                            ...
                            <tr>
                                <td class="buttonRow" colspan="2">
                                    <input type="button" value="<fmt:message key="save"/>"
                                           ...
                                           onclick="javascript:submitEndpointData('Http','<%=isAnonymous%>','<%=isFromTemplateEditor%>');"/>
                                    <%
                            ...
                            <tr>
                                <td class="buttonRow">
                                    <input type="button" class="button"
                                           ...
                                           onclick="javascript:submitDynamicEndpointData('Http','<%=isFromTemplateEditor%>'); return false;"/>
                                    <input type="button" class="button"
