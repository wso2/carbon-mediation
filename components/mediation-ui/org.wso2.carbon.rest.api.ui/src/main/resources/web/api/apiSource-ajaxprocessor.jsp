...
<carbon:jsi18n
                resourceBundle="org.wso2.carbon.rest.api.ui.i18n.JSResources"
                request="<%=request%>" />

    <div>
        <form action="api-source-update.jsp" id="mediator-source-form" name="mediator-source-form" method="post">
