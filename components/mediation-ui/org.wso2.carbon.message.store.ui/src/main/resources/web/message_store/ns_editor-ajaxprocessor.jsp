                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="600" id="nsTable"
                                ...
                                <tbody id="nsTBody">
                                    ...
                                    <tr id="nsTR<%=i%>">
                                        ...
                                        <td>
                                            <input id="uri<%=i%>" class="longInput" name="uri<%=i%>" type="text"
                                                   value="<%=uri%>"/>
                ...
                <tr>
                    <td class="buttonRow" colspan="3">
                        <input style="<%=displayStyle%>" id="addNSButton" class="button" name="addNSButton"
                               type="button"
                               onclick="javascript: addNameSpace('<fmt:message key="ns.delete"/>',
                                       '<fmt:message key="ns.prefixemptyerror"/>',
                                       '<fmt:message key="ns.uriemptyerror"/>'); return false;"
                               href="#"
                               value="<fmt:message key="ns.add"/>"/>
                        <input id="saveNSButton" class="button" name="saveNSButton" type="button"
                               onclick="javascript: saveNameSpace('<%=divID%>', '<%=currentID%>', '<%=linkID%>',
                                       '<fmt:message key="ns.prefixemptyerror.save"/>',
                                       '<fmt:message key="ns.uriemptyerror.save"/>',
                                       <%=isSingle ? "true" : "false"%>, '<%=name%>'); return false;"
