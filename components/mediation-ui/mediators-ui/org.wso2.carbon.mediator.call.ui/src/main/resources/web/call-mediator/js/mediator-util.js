...
function showEpAddtionalOptions(selectedOp){
    ...
    if(selectedOp == 'registryEp') {
        ...
        showElem('call_xpath');
        showElem('mediator.call.xpath_nmsp');
    }
}
...
function hideEpOps() {
    ...
    hideElem('call_xpath');
    hideElem('mediator.call.xpath_nmsp');
}
...
function anonEpEdit() {
    window.location.href = '../call-mediator/anon_endpoints_ajaxprocessor.jsp?anonEpAction=edit';
}

function anonEpAdd() {
    window.location.href = '../call-mediator/anon_endpoints_ajaxprocessor.jsp?anonEpAction=add';
}
