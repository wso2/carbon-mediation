...
import org.wso2.carbon.inbound.endpoint.protocol.generic.GenericBusyWait;
...
public class InboundRequestProcessorFactoryImpl implements InboundRequestProcessorFactory {
    ...
    public InboundRequestProcessor createInboundProcessor(InboundProcessorParams params) {
        ...
        if (protocol != null) {
            ...
            }else if (GenericWaitingConsumer.isBusyWaitingInboundEndpoint(params)) {
                inboundRequestProcessor = new GenericBusyWait(params);
            } else {
