    ...
    public KAFKAProcessor(InboundProcessorParams params) {
        ...
        if (inboundEndpointInterval != null) {
            try {
                ...
                log.error("Invalid numeric value for interval.");
        ...
        if (inboundEndpointSequential != null) {
            try {
                ...
                log.error("The sequential value should be true or false");
        ...
        if (inboundCoordination != null) {
            try {
                ...
                log.error("The Coordination value should be true or false");
