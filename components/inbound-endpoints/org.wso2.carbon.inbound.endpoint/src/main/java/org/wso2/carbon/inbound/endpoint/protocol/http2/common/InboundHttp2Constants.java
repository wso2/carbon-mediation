...
public class InboundHttp2Constants {
	...
	public static final String INBOUND_DISPATCH_SEQUENCE = "http2.outflow.dispatch.sequence";
	public static final String INBOUND_ERROR_SEQUENCE = "http2.outflow.error.sequence";
	public static final String INBOUND_SERVER_PUSH_ENABLED = "http2.server.push.enabled";

	public static final String HTTP2_CONTENT_TYPE = "ContentType";
}
