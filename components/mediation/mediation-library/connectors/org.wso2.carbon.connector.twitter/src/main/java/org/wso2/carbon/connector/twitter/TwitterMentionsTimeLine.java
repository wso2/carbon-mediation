...
public class TwitterMentionsTimeLine extends AbstractTwitterConnector {

	private static Log log = LogFactory.getLog(TwitterMentionsTimeLine.class);
		...
		try {
			...
			if (page != null && !page.isEmpty()) {
				if (count == null && sinceID == null && maxID == null) {
					...
					results =
					          twitter.getMentionsTimeline(new Paging(Integer.parseInt(page),
