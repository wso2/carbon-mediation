...
public class TwitterGetDirectMessages extends AbstractTwitterConnector {

	private static Log log = LogFactory.getLog(TwitterGetDirectMessages.class);
		...
		try {
			...
			if (page != null && !page.isEmpty()) {
				if (count == null && sinceID == null && maxID == null) {
					...
					results =
					          twitter.getDirectMessages(new Paging(Integer.parseInt(page),
				...
				results = twitter.getDirectMessages(new Paging(Integer.parseInt(sinceID)));
			} else {
				results = twitter.getDirectMessages();
			}
