...
public class Message implements org.apache.thrift.TBase<Message, Message._Fields>, java.io.Serializable, Cloneable, Comparable<Message> {
  ...
  public String incomingTransport; // required
  ...
  public Message(Message other) {
    ...
    if (other.isSetTransportHeaders()) {
      Map<String,String> __this__transportHeaders = new HashMap<String,String>(other.transportHeaders);
  ...
  public void unsetIsDoingREST() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __ISDOINGREST_ISSET_ID);
  }

  /** Returns true if field isDoingREST is set (has been assigned a value) and false otherwise */
  public boolean isSetIsDoingREST() {
    return EncodingUtils.testBit(__isset_bitfield, __ISDOINGREST_ISSET_ID);
  }

  public void setIsDoingRESTIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __ISDOINGREST_ISSET_ID, value);
  }
  ...
  public void unsetIsDoingMTOM() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __ISDOINGMTOM_ISSET_ID);
  }

  /** Returns true if field isDoingMTOM is set (has been assigned a value) and false otherwise */
  public boolean isSetIsDoingMTOM() {
    return EncodingUtils.testBit(__isset_bitfield, __ISDOINGMTOM_ISSET_ID);
  }

  public void setIsDoingMTOMIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __ISDOINGMTOM_ISSET_ID, value);
  }
  ...
  public void unsetIsDoingSwA() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __ISDOINGSWA_ISSET_ID);
  }

  /** Returns true if field isDoingSwA is set (has been assigned a value) and false otherwise */
  public boolean isSetIsDoingSwA() {
    return EncodingUtils.testBit(__isset_bitfield, __ISDOINGSWA_ISSET_ID);
  }

  public void setIsDoingSwAIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __ISDOINGSWA_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case INCOMING_TRANSPORT:
      if (value == null) {
        ...
        setIncomingTransport((String)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    boolean present_soapAction = true && (isSetSoapAction());
    list.add(present_soapAction);
    if (present_soapAction)
      list.add(soapAction);
    ...
    boolean present_transportHeaders = true && (isSetTransportHeaders());
    list.add(present_transportHeaders);
    if (present_transportHeaders)
      list.add(transportHeaders);

    boolean present_requestURI = true && (isSetRequestURI());
    list.add(present_requestURI);
    if (present_requestURI)
      list.add(requestURI);

    boolean present_isDoingREST = true;
    list.add(present_isDoingREST);
    if (present_isDoingREST)
      list.add(isDoingREST);

    boolean present_httpMethod = true && (isSetHttpMethod());
    list.add(present_httpMethod);
    if (present_httpMethod)
      list.add(httpMethod);

    boolean present_isDoingMTOM = true;
    list.add(present_isDoingMTOM);
    if (present_isDoingMTOM)
      list.add(isDoingMTOM);

    boolean present_isDoingSwA = true;
    list.add(present_isDoingSwA);
    if (present_isDoingSwA)
      list.add(isDoingSwA);

    boolean present_incomingTransport = true && (isSetIncomingTransport());
    list.add(present_incomingTransport);
    if (present_incomingTransport)
      list.add(incomingTransport);
  ...
  public int compareTo(Message other) {
    ...
    lastComparison = Boolean.valueOf(isSetSoapAction()).compareTo(other.isSetSoapAction());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSoapAction()) {
    ...
    lastComparison = Boolean.valueOf(isSetTransportHeaders()).compareTo(other.isSetTransportHeaders());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetRequestURI()).compareTo(other.isSetRequestURI());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRequestURI()) {
    ...
    lastComparison = Boolean.valueOf(isSetIsDoingREST()).compareTo(other.isSetIsDoingREST());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIsDoingREST()) {
    ...
    lastComparison = Boolean.valueOf(isSetIsDoingMTOM()).compareTo(other.isSetIsDoingMTOM());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIsDoingMTOM()) {
    ...
    lastComparison = Boolean.valueOf(isSetIsDoingSwA()).compareTo(other.isSetIsDoingSwA());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIsDoingSwA()) {
    ...
    lastComparison = Boolean.valueOf(isSetIncomingTransport()).compareTo(other.isSetIncomingTransport());
    if (lastComparison != 0) {
      return lastComparison;
    }
