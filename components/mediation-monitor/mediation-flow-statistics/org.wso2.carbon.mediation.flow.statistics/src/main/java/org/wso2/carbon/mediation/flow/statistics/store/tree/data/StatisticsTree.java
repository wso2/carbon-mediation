...
public class StatisticsTree {
	...
	private void traverseAndGetTree(IndividualStatistics treeNode, List<TreeNodeData> statisticsTreeNodes,
		...
		for (IndividualStatistics individualStatistics : treeNode.getChildren()) {
			...
			traverseAndGetTree(individualStatistics, statisticsTreeNodes, statisticsTreeEdges);
		}
	}
	 ...
	 */
	public void buildTree(ArrayList<StatisticsLog> statisticsLogs) {

		IndividualStatistics currentStat = root;
	...
	public StatisticsCompositeObject getCompositeDataObject(IndividualStatistics individualStatistics) {
		if (individualStatistics != null) {
			return new StatisticsCompositeObject(individualStatistics.getComponentId(),
			                                     ...
			                                     individualStatistics.getIsResponse(), individualStatistics.getCount(),
