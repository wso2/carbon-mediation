 ...
 */
package org.wso2.carbon.das.mediationstats.data.publisher.conf;
...
import org.wso2.carbon.das.mediationstats.data.publisher.util.MediationPublisherException;
...
//            }
    ...
    public void update(MediationStatConfig eventConfig, int tenantId) {
        try {
            ...
            updateConfigProperty(DASDataPublisherConstants.DAS_URL, eventConfig.getUrl(),registry);
