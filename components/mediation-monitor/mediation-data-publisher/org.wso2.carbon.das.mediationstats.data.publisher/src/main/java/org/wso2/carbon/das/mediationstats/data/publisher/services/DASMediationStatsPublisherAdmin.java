 ...
 */
package org.wso2.carbon.das.mediationstats.data.publisher.services;
...
public class DASMediationStatsPublisherAdmin extends AbstractAdmin {

    private RegistryPersistenceManager registryPersistenceManager;

    public DASMediationStatsPublisherAdmin() {
    ...
    public MediationStatConfig getEventingConfigData() {
        return registryPersistenceManager.getEventingConfigData(CarbonContext.getThreadLocalCarbonContext().getTenantId());
    }
