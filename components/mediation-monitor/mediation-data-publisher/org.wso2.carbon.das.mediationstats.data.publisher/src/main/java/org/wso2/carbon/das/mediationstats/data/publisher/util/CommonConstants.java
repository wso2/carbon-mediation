 ...
 */
package org.wso2.carbon.das.mediationstats.data.publisher.util;
...
public class CommonConstants {
    ...
    public static final String SERVICE_COMMON_REG_PATH = RegistryResources.COMPONENTS
                                                   + "org.wso2.carbon.das.service.data.publisher/common/";

    public static final String SERVICE_PROPERTIES_REG_PATH = RegistryResources.COMPONENTS
                                                   + "org.wso2.carbon.das.service.data.publisher/properties";

    public  static final String CARBON_XML = "carbon.xml";
    public static final String DAS_CARBON_STATISTICS_REPORTER = "StatisticsReporterDisabled";
    public static final String DAS_CARBON_STATISTIC_REPORTER_DISABLED = "false";
