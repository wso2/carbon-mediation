 ...
 */
public class MessageFlowProcessor implements MessageFlowProcessorInterface {

	private static final Log log = LogFactory.getLog(org.apache.synapse.aspects.flow.statistics.log.StatisticEventProcessor.class);

    private StatisticsEntry entry;

    private MessageFlowObserverStore messageFlowObserverStore;

    public MessageFlowProcessor(MessageFlowObserverStore messageFlowObserverStore) {
