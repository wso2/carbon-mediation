 ...
 */
package org.wso2.carbon.das.mediationstats.data.publisher.ui;
...
import org.wso2.carbon.das.mediationstats.data.publisher.stub.DASMediationStatPublisherAdminStub;
import org.wso2.carbon.das.mediationstats.data.publisher.stub.conf.MediationStatConfig;
...
public class MediationStatPublisherAdminClient {
	...
	private DASMediationStatPublisherAdminStub stub;
    ...
    public MediationStatPublisherAdminClient(String cookie, String backendServerURL,
        ...
        stub = new DASMediationStatPublisherAdminStub(configCtx, serviceURL);
