...
/*        Map<String, Object> errorMap = mediationData.getErrorMap();
	...
	private static void publishToAgent(List<Object> eventData, List<String> metaDataKeyList,
	                                   List<String> metaDataValueList, MediationStatConfig mediationStatConfig) {
	...
	public static StreamDefinition getEventStreamDefinition(MediationStatConfig mediationStatConfig, Object[] metaData)
		...
		StreamDefinition eventStreamDefinition =
				new StreamDefinition(mediationStatConfig.getStreamName(), mediationStatConfig.getVersion());
		...
		eventStreamDefinition.addPayloadData(MediationDataPublisherConstants.DIRECTION, AttributeType.STRING);
		eventStreamDefinition.addPayloadData(BAMDataPublisherConstants.TIMESTAMP, AttributeType.LONG);
		eventStreamDefinition.addPayloadData(MediationDataPublisherConstants.RESOURCE_ID, AttributeType.STRING);
		eventStreamDefinition.addPayloadData(MediationDataPublisherConstants.STATS_TYPE, AttributeType.STRING);
		eventStreamDefinition.addPayloadData(MediationDataPublisherConstants.MAX_PROCESS_TIME, AttributeType.LONG);
		eventStreamDefinition.addPayloadData(MediationDataPublisherConstants.AVG_PROCESS_TIME, AttributeType.DOUBLE);
		eventStreamDefinition.addPayloadData(MediationDataPublisherConstants.MIN_PROCESS_TIME, AttributeType.LONG);
		eventStreamDefinition.addPayloadData(MediationDataPublisherConstants.FAULT_COUNT, AttributeType.INT);
		eventStreamDefinition.addPayloadData(MediationDataPublisherConstants.COUNT, AttributeType.INT);
