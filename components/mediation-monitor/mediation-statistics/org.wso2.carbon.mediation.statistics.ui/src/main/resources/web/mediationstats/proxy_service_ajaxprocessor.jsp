...
<fmt:bundle basename="org.wso2.carbon.mediation.statistics.ui.i18n.Resources">
    ...
    <%
        ...
        try {
            record = client.getProxyServiceStatistics(name);
       ...
       <tr>
            <td width="50%">
                ...
                <table class="styledLeft" id="sequenceStatsTable" width="100%">
                    <thead>
                    <tr>
                        <th colspan="2" align="left"><%=name%> <fmt:message key="proxy.service.in.statistics"/></th>
                    </tr>
                    </thead>
                ...
                <table class="styledLeft" id="sequenceStatsTable2" width="100%">
                    <thead>
                    <tr>
                        <th colspan="2" align="left"><%=name%> <fmt:message key="proxy.service.out.statistics"/></th>
                    </tr>
                    </thead>
                    <tr class="tableOddRow">
                        <td width="40%"><fmt:message key="total.count"/></td>
                    ...
                    <tr class="tableOddRow">
                        <td><fmt:message key="maximum.response.time"/></td>
                        <td>
                            <%if (outRecord.getTotalCount() > 0 && outRecord.getMaxTime() <= 0) { %>
                            &lt; 1 ms
                            <%} else {%>
