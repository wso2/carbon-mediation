...
/**
 * Bean class to represent a combination of in-out records.
 */
public class InOutStatisticsRecord {
    ...
    public void setInRecord(StatisticsRecord inRecord) {
    ...
    public void setOutRecord(StatisticsRecord outRecord) {
