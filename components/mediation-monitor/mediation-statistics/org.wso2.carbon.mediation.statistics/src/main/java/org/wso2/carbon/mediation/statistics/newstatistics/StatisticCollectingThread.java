...
public class StatisticCollectingThread extends Thread {
	...
	public StatisticCollectingThread(SynapseEnvironmentService synEnvSvc, StatisticNotifier statisticNotifier) {
	...
	private void reportStatistics() {
		List<ArrayList<StatisticsLog>> statitisticEntries =
