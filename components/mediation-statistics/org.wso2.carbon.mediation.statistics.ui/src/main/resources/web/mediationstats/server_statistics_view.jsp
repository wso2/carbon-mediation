...
<carbon:breadcrumb label="Server Statistics"
    ...
    <div id="middle">
        <h2><fmt:message key="server.statistics"/></h2>
        <div id="workArea">
            <table width="100%">
                <tr>
                    <td>
                       <div id="result"></div>
                            <script type="text/javascript">
                                ...
                                function refreshStats() {
                                    var url = "category_graph_ajaxprocessor.jsp?category=<%=MediationStatisticsClient.SERVER_STATISTICS%>";
