...
import org.wso2.carbon.mediator.dataservice.DataServiceCallMediator.OPERATIONS_TYPE;
...
public class DataServiceCallMediatorFactory extends AbstractMediatorFactory {
    ...
    public Mediator createSpecificMediator(OMElement elem, Properties properties) {
        ...
        OPERATIONS_TYPE operationsType = OPERATIONS_TYPE.valueOf(operationType.toUpperCase());
