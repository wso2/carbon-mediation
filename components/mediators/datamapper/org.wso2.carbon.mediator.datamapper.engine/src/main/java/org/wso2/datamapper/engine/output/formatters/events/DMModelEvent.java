 ...
 * under the License.
 */
package org.wso2.datamapper.engine.output.formatters.events;
 ...
 *
 */
public class DMModelEvent {

    private ReaderEventTypes.EventType eventType;
    private String name;
    private Object value;

    public DMModelEvent(ReaderEventTypes.EventType eventType, String name, Object value) {
