...
public class XMLMapOutputFormatter {
    ...
    /**
     * Initiate the XML message building process
     *
     * @param model Map model generated by the script engine
     * @param outputXMLMessageBuilder Reference of the builder to notify the result with
     ...
     *
     * @param outputMap Current level of the Map
     */
    ...
    /* Following methods are used to build the XML message */
