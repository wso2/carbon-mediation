 ...
 * under the License.
 */
package org.wso2.carbon.business.messaging.hl7.store.internal;
...
import org.wso2.carbon.business.messaging.hl7.store.util.ConfigHolder;
...
@Component(
        ...
        immediate = true)
public class HL7StoreAdminServiceComponent extends AbstractAxis2ConfigurationContextObserver {

    private static Log log = LogFactory.getLog(HL7StoreAdminServiceComponent.class);
